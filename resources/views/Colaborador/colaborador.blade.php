...
<div class="card">
    <div class="card-header cabecera_pantalla">
        ...
        <div class="float-right mr-3" data-intro="Permite agregar supervisores al agrupador seleccionado.">
            <button class="btn btn-block btn-primary" type="button" id="crea_cont_super">
        ...
        <div class="float-left" data-intro="Permite seleccionar el “agrupador”.">
            <select name="subtipo" id="agrupador_supe" class="custom-select">
                <option value="" disabled="" selected="">Seleccione</option>
            </select>
        </div>

        <div class="float-left ml-2" data-intro="Lista los supervisores relacionados al agrupador seleccionado.">
            <a data-target="#modal-create-usuario" data-toggle="modal" href="" style="text-decoration: none !important">
                <button type="button" class="btn btn-block btn-primary" id="busc_super">
...
@include('Colaborador.modal_create_colaborador')
@push('scripts')
<script src="intro.js"></script>
<script type="text/javascript" src="js/sweetalert2@8.js" ></script>
<script src="Folder/colaborador.js"></script>
