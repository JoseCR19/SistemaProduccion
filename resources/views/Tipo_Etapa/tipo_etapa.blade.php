...
<div class="card">
    <div class="card-header cabecera_pantalla">
        ...
        <div class="float-right mr-3" data-intro="Permite registrar un nuevo “Tipo Etapa”.">
    ...
    <div class="card-body default" data-intro="<b>Editar:</b><br>Permite realizar cambios en los datos registrados de un “Tipo Etapa”.">
        <div id='jqxWidget'>
            <div id="grid"></div>
...
@include('Tipo_Etapa.modal_edit_tipo_etapa')
@include('Tipo_Etapa.modal_create_tipo_etapa')
@push('scripts')
<script src="intro.js"></script>
<script type="text/javascript" src="js/sweetalert2@8.js" ></script>
<script type="text/javascript" src="Folder/tipo_etapa.js"></script>
