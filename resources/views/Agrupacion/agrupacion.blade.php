...
<div class="card">
    <div class="card-header cabecera_pantalla">
        ...
        <div class="float-right mr-3" data-intro="Permite registrar un nuevo “Agrupador”">
    ...
    <div class="card-body default" data-intro="<b>Editar:</b><br>Permite realizar cambios en los datos registrados de un “Agrupador”.">
        <div id='jqxWidget'>
            <div id="grid"></div>
...
@include('Agrupacion.modal_edit_agrupacion')
@include('Agrupacion.modal_create_agrupacion')
@push('scripts')
<script src="intro.js"></script>
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@8"></script>
<script type="text/javascript" src="Folder/agrupacion.js"></script>
