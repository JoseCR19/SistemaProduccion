...
<div class="card">
    <div class="card-header cabecera_pantalla">
        ...
        <div id="create" class="float-right mr-3" data-intro="Permite registrar un nuevo “Tipo Estructurado”." style="color:white;border-color:transparent !important;background:transparent !important">
    ...
    <div class="card-body default" data-intro="<b>Editar:</b><br>Permite realizar cambios en los datos registrados de un “Tipo Estructurado”.">
        <div id='jqxWidget'>
            <div id="grid"></div>
...
@include('TipoEstructurado.modal_create_tipoestructurado')
@include('TipoEstructurado.modal_edit_tipoestructurado')
@push('scripts')
...
<script type="text/javascript" src="Folder/tipoestructurado.js"></script>
