<div class="modal fade bd-example-modal-lg" id="modal-guia-recibida" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content card-info card">
            <div class="modal-header card-header">
                <h5 class="modal-title" id="exampleModalLabel">Guia Recibida</h5>
            ...
            <form action="" id="form_register_guia_recibida" enctype="multipart/form-data" method="POST">
                <input type="text" id="id_guia_recibida"  class="form-control" name="id_guia_recibida" style="display:none" >
                <input type="text" id="nombre_carpeta_recibida"  class="form-control" name="nombre_carpeta_recibida" style="display:none" >
                <input type="text" id="usuario_guia_recibida"  class="form-control" name="usuario_guia_recibida" style="display:none" >
