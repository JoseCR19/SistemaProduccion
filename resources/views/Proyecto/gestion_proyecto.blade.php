...
<div class="card">
    <div class="card-header cabecera_pantalla">
        ...
        <div class="float-right mr-3" data-intro="Vuelve a cargar la tabla para ver reflejados los cambios realizados.">
            <button class="btn btn-block btn-primary" type="button" id="actualizar_listar">
    ...
    <div class="card-body default" data-intro="<b>Editar:</b><br>Permite modificar el campo “ALIAS” del proyecto.">
        <div id='jqxWidget'>
            <div id="grid"></div>
...
@include('Proyecto.modal_edit_proyecto')
@include('Proyecto.modal_detalle_proyecto')
@push('scripts')
<script src="intro.js"></script>
<script type="text/javascript" src="js/sweetalert2@8.js" ></script>
<script type="text/javascript" src="Folder/proyectos.js"></script>
