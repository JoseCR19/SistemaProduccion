        ...
        <div class="row mb-1">
            ...
            <div class="col-md-2">
                <div class="form-group ">
                    ...
                    <div style='float: left;' id='cabina_segui_pintura'>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group ">
                    <label for="inputPassword3" style="font-weight:500 !important">LOTE PINTURA</label>
                    <div style='float: left;' id='lote_pintura'>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group ">
                    ...
                    <div style='float: left;' id='contratista'>
                    </div>
                </div>
            </div>
...
@include('Reportar_Pintura.modal_ver_lotes')
@push('scripts')
...
<script type="text/javascript" src="Folder/seguimiento_pintura.js"></script>
