...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const applicationServerKey =
            'BPjBa9oNt2QXRsbN8iVAH4EhTiiJwbDzR4eDwl8YMashWdIlw3gKeZGZ_nsnUIvY7qmr0MbFSsZ1Xlt9IWMPEdc';
    let isPushEnabled = false;
    // Sirve para suscribirse
    ...
    if ('serviceWorker' in navigator) {
        ...
        navigator.serviceWorker.register('serviceworker.js', {
           ...
           // console.log('Laravel PWA: ServiceWorker registration successful with scope: ', registration.scope);
            //Si tengo suscripcion y hay una modificacion uso este metodo
...
*/
    ...
    function push_sendSubscriptionToServer(subscription, method) {
        ...
        $.ajax({
            ...
            data: {
                ...
                publicKey: key ? btoa(String.fromCharCode.apply(null, new Uint8Array(key))) : null,
                authToken: token ? btoa(String.fromCharCode.apply(null, new Uint8Array(token))) : null,
                codi_usua: codigo_usuario
            },
            dataType: 'json',
            success: function (html) {
                var respuesta = html.mensaje;
                if (respuesta == "") {


                } else {
                    console.log("asd" + respuesta);
                }
            }
        });
    }
    ...
    sendPushButton.addEventListener('click', () =>
        navigator.serviceWorker.ready
                ...
                .then(subscription => {
                    if (!subscription) {
                        console.log('Please enable push notifications');
                        return;
                    }
                    ...
                    $.ajax({
                        ...
                        data: {
                            susc_usua: JSON.stringify(Object.assign(jsonSubscription, {contentEncoding})),
